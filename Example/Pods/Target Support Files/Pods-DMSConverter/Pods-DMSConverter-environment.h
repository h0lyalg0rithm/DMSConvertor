...
// DMSConverter
#define COCOAPODS_POD_AVAILABLE_DMSConverter
#define COCOAPODS_VERSION_MAJOR_DMSConverter 0
#define COCOAPODS_VERSION_MINOR_DMSConverter 1
#define COCOAPODS_VERSION_PATCH_DMSConverter 0
